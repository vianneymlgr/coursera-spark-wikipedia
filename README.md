# coursera-spark-wikipedia

To start, first download the data (133 MB): [wikipedia](http://alaska.epfl.ch/~dockermoocs/bigdata/wikipedia.dat)
...
_Hint: You might want to use methods flatMap and groupByKey on RDD for this part._
